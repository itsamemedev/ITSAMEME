...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef ITSAMEME_CHAINPARAMSSEEDS_H\n')
    g.write('#define ITSAMEME_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the itsameme network\n')
    ...
    g.write('#endif // ITSAMEME_CHAINPARAMSSEEDS_H\n')
