...
This directory contains the files necessary to perform bootstrappable ITSAMEME
Core builds.
...
To build ITSAMEME Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      ITSAMEME Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/itsameme-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/itsameme-core/guix.sigs).
