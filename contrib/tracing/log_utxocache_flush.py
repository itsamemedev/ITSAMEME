...
"""Example logging ITSAMEME Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/itsamemed
...
def main(itsamemed_path):
    ...
    b = BPF(text=program, usdt_contexts=[itsamemed_with_usdts])
