...
""" Interactive itsamemed P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for ITSAMEME Core can enable. It uses BCC
...
def main(itsamemed_path):
    ...
    itsamemed_with_usdts.enable_probe(
