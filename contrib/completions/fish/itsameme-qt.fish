...
complete --command itsameme-qt --no-files

# Extract options
function __fish_itsamemeqt_get_options
...
complete \
    --command itsameme-qt \
    --arguments "(__fish_itsamemeqt_get_options --nofiles)"
