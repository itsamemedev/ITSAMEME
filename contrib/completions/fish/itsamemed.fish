...
complete --command itsamemed --no-files

# Extract options
function __fish_itsamemed_get_options
...
complete \
    --command itsamemed \
    --arguments "(__fish_itsamemed_get_options --nofiles)"
