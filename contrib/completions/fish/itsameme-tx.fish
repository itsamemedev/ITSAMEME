...
# Extract options
function __fish_itsameme_tx_get_options
...
# Extract commands
function __fish_itsameme_tx_get_commands
...
complete \
    --command itsameme-tx \
    --condition "not __fish_itsameme_seen_cmd (__fish_itsameme_tx_get_commands --commandsonly)" \
    --arguments "(__fish_itsameme_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command itsameme-tx \
    --arguments "(__fish_itsameme_tx_get_commands)" \
    --no-files
