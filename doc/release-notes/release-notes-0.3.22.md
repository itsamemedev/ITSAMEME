Download URL: https://sourceforge.net/projects/itsameme/files/ITSAMEME/itsameme-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 IAM fee schedule (users still pay 0.01 IAM per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #itsameme00 - #itsameme99
