ITSAMEME Core version 0.9.2.1 is now available from:

  https://itsameme.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 IAM to 0.01 IAM
...
- Fix "Start itsameme on system login"
