ITSAMEME Core version 0.9.4 is now available from:

  https://itsameme.org/bin/0.9.4/
...
this update is incompatible with the ITSAMEME system and could lead to consensus
forks.

ITSAMEME Core released binaries from https://itsameme.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~itsameme/+archive/ubuntu/itsameme
- A third-party or self-compiled ITSAMEME Core

upgrade to ITSAMEME Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
