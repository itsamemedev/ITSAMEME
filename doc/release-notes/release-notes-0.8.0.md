ITSAMEME-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/itsameme/files/ITSAMEME/itsameme-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the ITSAMEME
...
New/changed settings (command-line or itsameme.conf file)
--------------------------------------------------------
