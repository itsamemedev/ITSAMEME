ITSAMEME Core version 0.13.2 is now available from:

  <https://itsameme.org/bin/itsameme-core-0.13.2/>
...
- #8908 `4a974b2` Update itsameme-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow itsameme-tx to create v2 transactions (iamdrak)
