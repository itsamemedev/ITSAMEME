ITSAMEME Core version 0.10.4 is now available from:

  <https://itsameme.org/bin/itsameme-core-0.10.4/>
...
- #6953 `43c2789` Split itsameme-tx into its own package
- #6953 `dfe0d4d` Include itsameme-tx binary on Debian/Ubuntu
