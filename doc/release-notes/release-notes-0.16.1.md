ITSAMEME Core version 0.16.1 is now available from:

  <https://bitcoincore.org/bin/itsameme-core-0.16.1/>
...
- #12843 `df38b13` Test starting itsamemed with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure itsamemed processes are cleaned up when tests end (sdaftuar)
