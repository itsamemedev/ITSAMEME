ITSAMEME version 0.5.4 is now available for download at:
http://sourceforge.net/projects/itsameme/files/ITSAMEME/itsameme-0.5.4/
...
http://gitorious.org/itsameme/itsamemed-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix ITSAMEME-Qt notifications under Growl 1.3.
Increase required age of ITSAMEME-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxITSAMEME properly when installing ITSAMEME-Qt over it. (Windows)
