...
This document provides guidelines for internationalization of the ITSAMEME Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `itsameme_en.ts` remains unchanged.
