...
#ifndef ITSAMEME_ARITH_UINT256_H
#define ITSAMEME_ARITH_UINT256_H
...
public:
     ...
     *
     * ITSAMEME only uses this "compact" format for encoding difficulty
...
#endif // ITSAMEME_ARITH_UINT256_H
