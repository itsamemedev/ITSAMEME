...
#ifndef ITSAMEME_SCRIPT_STANDARD_H
#define ITSAMEME_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a itsameme address
 */
...
/**
 * Generate a ITSAMEME scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // ITSAMEME_SCRIPT_STANDARD_H
