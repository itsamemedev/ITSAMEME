      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->itsamemeAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->itsamemeAtStartup);
    ...
    ui->itsamemeAtStartup->setToolTip(ui->itsamemeAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->itsamemeAtStartup->setText(ui->itsamemeAtStartup->text().arg(PACKAGE_NAME));

    ui->openITSAMEMEConfButton->setToolTip(ui->openITSAMEMEConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ITSAMEMEUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->itsamemeAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSIAMontrols);
...
void OptionsDialog::on_openITSAMEMEConfButton_clicked()
{
