...
{
    // Test regression https://github.com/itsamemedev/ITSAMEME/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/itsameme-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/itsameme-core/gui/pull/568.
    // With fListen=false in ~/.config/ITSAMEME/ITSAMEME-Qt.conf and all else left as default,
    // itsameme-qt should set both -listen and -listenonion to false and start successfully.
