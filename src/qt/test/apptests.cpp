...
//! Entry point for ITSAMEMEApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ITSAMEMEApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ITSAMEMEGUI tests.
void AppTests::guiTests(ITSAMEMEGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ITSAMEMEGUI::consoleShown, this, &AppTests::consoleTests);
