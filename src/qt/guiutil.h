...
#ifndef ITSAMEME_QT_GUIUTIL_H
#define ITSAMEME_QT_GUIUTIL_H
...
/** Utility functions used by the ITSAMEME Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "itsameme:" URI into recipient object, return true on successful parsing
