...
#ifndef ITSAMEME_CRYPTO_CHACHA_POLY_AEAD_H
#define ITSAMEME_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@itsameme.
 *
 ...
 *
 * The chacha20-poly1305@itsameme combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@itsameme cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@itsameme are relatively fast in
...
#endif // ITSAMEME_CRYPTO_CHACHA_POLY_AEAD_H
