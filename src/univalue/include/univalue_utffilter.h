...
#ifndef ITSAMEME_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define ITSAMEME_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // ITSAMEME_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
