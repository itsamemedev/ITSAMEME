...
//
// The itsameme-chainstate executable serves to surface the dependencies required
// by a program wishing to use ITSAMEME Core's consensus engine as it is right
// now.
//
// DEVELOPER NOTE: Since this is a "demo-only", experimental, etc. executable,
//                 it may diverge from ITSAMEME Core's coding style.
//
// It is part of the libitsamemekernel project.
