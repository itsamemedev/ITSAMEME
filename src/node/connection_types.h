...
#ifndef ITSAMEME_NODE_CONNECTION_TYPES_H
#define ITSAMEME_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/itsameme-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on ITSAMEME’s Peer-to-Peer Network")
...
#endif // ITSAMEME_NODE_CONNECTION_TYPES_H
