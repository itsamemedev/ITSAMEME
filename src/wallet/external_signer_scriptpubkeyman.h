...
#ifndef ITSAMEME_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define ITSAMEME_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // ITSAMEME_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
