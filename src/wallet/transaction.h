...
#ifndef ITSAMEME_WALLET_TRANSACTION_H
#define ITSAMEME_WALLET_TRANSACTION_H
...
public:
     ...
     * on this itsameme node, and set to 0 for transactions that were created
...
#endif // ITSAMEME_WALLET_TRANSACTION_H
