...
#ifndef ITSAMEME_WALLET_SCRIPTPUBKEYMAN_H
#define ITSAMEME_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The ITSAMEME Core wallet was originally a collection of unrelated private
...
#endif // ITSAMEME_WALLET_SCRIPTPUBKEYMAN_H
