...
BOOST_AUTO_TEST_CASE(knapsack_solver_test)
{
    ...
    for (int i = 0; i < RUN_TESTS; i++)
    {
        ...
        BOOST_CHECK_EQUAL(result14->GetSelectedValue(), 1 * COIN);  // we should get 1 IAM in 1 coin
        ...
        BOOST_CHECK_EQUAL(result15->GetSelectedValue(), 2 * COIN);  // we should get 2 IAM in 1 coin
...
BOOST_AUTO_TEST_CASE(check_max_weight)
{
    ...
    {
        // Scenario 1:
        // The actor starts with 1x 50.0 IAM and 1515x 0.033 IAM (~100.0 IAM total) unspent outputs
        // Then tries to spend 49.5 IAM
        // The 50.0 IAM output should be selected, because the transaction would otherwise be too large
...

    {
        ...
        // The actor starts with 400x 0.0625 IAM and 2000x 0.025 IAM (75.0 IAM total) unspent outputs
        // Then tries to spend 49.5 IAM
...

    {
        ...
        // The actor starts with 1515x 0.033 IAM (49.995 IAM total) unspent outputs
...
BOOST_AUTO_TEST_CASE(SelectCoins_effective_value_test)
{
    ...
    CoinsResult available_coins;
    {
        ...
        add_coin(available_coins, *dummyWallet, 100000); // 0.001 IAM
    }

    CAmount target{99900}; // 0.000999 IAM
