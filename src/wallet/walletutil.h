...
#ifndef ITSAMEME_WALLET_WALLETUTIL_H
#define ITSAMEME_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! itsameme from opening the wallet, thinking it was newly created, and
...
#endif // ITSAMEME_WALLET_WALLETUTIL_H
