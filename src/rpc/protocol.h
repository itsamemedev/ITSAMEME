...
#ifndef ITSAMEME_RPC_PROTOCOL_H
#define ITSAMEME_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in itsamemed
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< ITSAMEME is not connected
