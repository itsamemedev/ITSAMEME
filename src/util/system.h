 ...
 */
#ifndef ITSAMEME_UTIL_SYSTEM_H
#define ITSAMEME_UTIL_SYSTEM_H
...
extern const char * const ITSAMEME_CONF_FILENAME;
extern const char * const ITSAMEME_SETTINGS_FILENAME;
