...
#ifndef ITSAMEME_UTIL_SYSCALL_SANDBOX_H
#define ITSAMEME_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during itsamemed initialization if ITSAMEME Core was compiled
...
#endif // ITSAMEME_UTIL_SYSCALL_SANDBOX_H
