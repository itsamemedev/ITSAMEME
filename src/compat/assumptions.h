...
#ifndef ITSAMEME_COMPAT_ASSUMPTIONS_H
#define ITSAMEME_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "ITSAMEME cannot be compiled without assertions."
#endif
...
#endif // ITSAMEME_COMPAT_ASSUMPTIONS_H
