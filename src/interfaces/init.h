...
#ifndef ITSAMEME_INTERFACES_INIT_H
#define ITSAMEME_INTERFACES_INIT_H
...
//! (itsameme-gui, itsameme-node, itsameme-wallet, itsamemed, itsameme-qt) and each
...
#endif // ITSAMEME_INTERFACES_INIT_H
