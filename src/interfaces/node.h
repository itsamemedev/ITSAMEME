...
#ifndef ITSAMEME_INTERFACES_NODE_H
#define ITSAMEME_INTERFACES_NODE_H
...
//! Top-level interface for a itsameme node (itsamemed process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or itsameme.conf.
...
#endif // ITSAMEME_INTERFACES_NODE_H
