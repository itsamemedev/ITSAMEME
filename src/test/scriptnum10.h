...
#ifndef ITSAMEME_TEST_SCRIPTNUM10_H
#define ITSAMEME_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from ITSAMEME Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // ITSAMEME_TEST_SCRIPTNUM10_H
