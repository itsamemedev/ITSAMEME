...
{
    BOOST_CHECK(TestSplitHost("www.itsamemecore.org", "www.itsamemecore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.itsamemecore.org]", "www.itsamemecore.org", 0));
    BOOST_CHECK(TestSplitHost("www.itsamemecore.org:80", "www.itsamemecore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.itsamemecore.org]:80", "www.itsamemecore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:16970", "127.0.0.1", 16970));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:16970", "127.0.0.1", 16970));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:16970", "::ffff:127.0.0.1", 16970));
    BOOST_CHECK(TestSplitHost("[::]:16970", "::", 16970));
    BOOST_CHECK(TestSplitHost("::16970", "::16970", 0));
    BOOST_CHECK(TestSplitHost(":16970", "", 16970));
    BOOST_CHECK(TestSplitHost("[]:16970", "", 16970));
    ...
    BOOST_CHECK(TestSplitHost("www.itsamemecore.org:65536", "www.itsamemecore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.itsamemecore.org:0", "www.itsamemecore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.itsamemecore.org:", "www.itsamemecore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:16970", "127.0.0.1:16970"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:16970", "[::]:16970"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
