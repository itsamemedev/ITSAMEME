...
**ITSAMEME Core's `configure` script by default will ignore the depends output.** In
...
options will be passed to itsameme's configure. In this case, `--disable-wallet`.
