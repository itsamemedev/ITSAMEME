...
class NetTest(ITSAMEMETestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=16970)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 16970)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=16970), {"success": False})
