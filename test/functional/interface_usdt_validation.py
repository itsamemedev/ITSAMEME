...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/itsamemedev/ITSAMEME/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(ITSAMEMETestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/itsamemedev/ITSAMEME/blob/master/doc/tracing.md#tracepoint-validationblock_connected
