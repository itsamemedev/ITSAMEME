...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/itsamemedev/ITSAMEME/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(ITSAMEMETestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our itsamemed node")
