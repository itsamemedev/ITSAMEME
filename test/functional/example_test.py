...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ITSAMEMETestFramework
    pass


class ExampleTest(ITSAMEMETestFramework):
    # Each functional test is a subclass of the ITSAMEMETestFramework class.
    ...
    def custom_method(self):
        ...
        ITSAMEMETestFramework class so other tests can use it."""
