...
By default, itsamemed will dump mempool on shutdown and
...
class MempoolPersistTest(ITSAMEMETestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent itsamemed from writing mempool.dat to disk. Verify that `savemempool` fails")
