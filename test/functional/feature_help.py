...
"""Verify that starting itsameme with -h works as expected."""

from test_framework.test_framework import ITSAMEMETestFramework
from test_framework.util import assert_equal

class HelpTest(ITSAMEMETestFramework):
    ...
    def run_test(self):
        self.log.info("Start itsameme with -h for help text")
        ...
        self.log.info("Start itsameme with -version for version information")
        ...
        self.log.info("Start itsamemed with -fakearg to make sure it does not start")
