...
"""
Test starting itsamemed with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(ITSAMEMETestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that itsamemed has bound on "::1" (for RPC) and "::" (for P2P).
