...
class TestShell:
    """Wrapper Class for ITSAMEMETestFramework.

    The TestShell class extends the ITSAMEMETestFramework
    ...
    class __TestShell(ITSAMEMETestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ITSAMEMETestFramework child class.
            self.num_nodes = 1
