...
class TransactionTimeRescanTest(ITSAMEMETestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine IAM and create transactions
        ...
        # generate some iam to create transactions and check blockcount
        ...
        # send 10 iam to user's first watch-only address
        self.log.info('Send 10 iam to user')
        ...
        # send 5 iam to our second watch-only address
        self.log.info('Send 5 iam to user')
        ...
        # send 1 iam to our third watch-only address
        self.log.info('Send 1 iam to user')
