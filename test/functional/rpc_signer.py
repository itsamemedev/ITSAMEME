...
Verify that a itsamemed node can use an external signer command.
...
class RPCSignerTest(ITSAMEMETestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart itsamemed with -signer=<cmd>',
