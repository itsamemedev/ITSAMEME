...
class TxnMallTest(ITSAMEMETestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 IAM:
        ...
        # First: use raw transaction API to send 1240 IAM to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 IAM coin each
        ...
        # Node0's balance should be starting balance, plus 50IAM for another
        ...
        # Node0's total balance should be starting balance, plus 100IAM for
